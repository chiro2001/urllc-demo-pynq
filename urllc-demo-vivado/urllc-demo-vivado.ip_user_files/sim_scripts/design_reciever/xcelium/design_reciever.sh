...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.design_reciever \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../urllc-demo-vivado.gen/sources_1/bd/design_reciever/bd/urllc_core_inst_2/ipshared/6dcf" \
       +incdir+"$ref_dir/../../../../urllc-demo-vivado.gen/sources_1/bd/design_reciever/bd/urllc_core_inst_2/ipshared/80cc/hdl/verilog" \
       +incdir+"$ref_dir/../../../../urllc-demo-vivado.gen/sources_1/bd/design_reciever/bd/urllc_core_inst_2/ipshared/22b9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../urllc-demo-vivado.gen/sources_1/bd/design_reciever/bd/urllc_core_inst_2/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../urllc-demo-vivado.gen/sources_1/bd/design_reciever/bd/urllc_core_inst_2/ipshared/f42d/hdl" \
