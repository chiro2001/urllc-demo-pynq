...
--               g:/Chiro/Programs/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.gen/sources_1/bd/design_reciever/bd/urllc_core_inst_2/ip/urllc_core_inst_2_ad2dma_rtl_0_0/urllc_core_inst_2_ad2dma_rtl_0_0_sim_netlist.vhdl
-- Design      : urllc_core_inst_2_ad2dma_rtl_0_0
...
entity urllc_core_inst_2_ad2dma_rtl_0_0_ad2dma_rtl is
  port (
  ...
  attribute ORIG_REF_NAME of urllc_core_inst_2_ad2dma_rtl_0_0_ad2dma_rtl : entity is "ad2dma_rtl";
end urllc_core_inst_2_ad2dma_rtl_0_0_ad2dma_rtl;

architecture STRUCTURE of urllc_core_inst_2_ad2dma_rtl_0_0_ad2dma_rtl is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity urllc_core_inst_2_ad2dma_rtl_0_0 is
  port (
    clk : in STD_LOGIC;
    resetn : in STD_LOGIC;
    in_axis_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of urllc_core_inst_2_ad2dma_rtl_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of urllc_core_inst_2_ad2dma_rtl_0_0 : entity is "urllc_core_inst_2_ad2dma_rtl_0_0,ad2dma_rtl,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of urllc_core_inst_2_ad2dma_rtl_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of urllc_core_inst_2_ad2dma_rtl_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of urllc_core_inst_2_ad2dma_rtl_0_0 : entity is "ad2dma_rtl,Vivado 2021.1";
end urllc_core_inst_2_ad2dma_rtl_0_0;

architecture STRUCTURE of urllc_core_inst_2_ad2dma_rtl_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF in_axis:out_axis, ASSOCIATED_RESET resetn, FREQ_HZ 8000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /urllc_core_0/multi_clock/clk_wiz_static_clk_out1, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of in_axis_tlast : signal is "xilinx.com:interface:axis:1.0 in_axis TLAST";
  attribute X_INTERFACE_PARAMETER of in_axis_tlast : signal is "XIL_INTERFACENAME in_axis, FREQ_HZ 8000000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, PHASE 0.0, CLK_DOMAIN /urllc_core_0/multi_clock/clk_wiz_static_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
...
begin
inst: entity work.urllc_core_inst_2_ad2dma_rtl_0_0_ad2dma_rtl
     port map (
