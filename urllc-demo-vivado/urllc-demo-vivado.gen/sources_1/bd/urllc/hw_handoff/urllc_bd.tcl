...
proc create_hier_cell_sender { parentCell nameHier } {
  ...
  # Create instance: p_s_0, and set properties
  set block_name p_s
  set block_cell_name p_s_0
  if { [catch {set p_s_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $p_s_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: rst_ps7_0_4M, and set properties
  set rst_ps7_0_4M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_4M ]
...
proc create_hier_cell_reciever { parentCell nameHier } {
  ...
  create_bd_pin -dir I clk_4M
  create_bd_pin -dir O -from 7 -to 0 da
  create_bd_pin -dir O -from 7 -to 0 data_check
  ...
  # Create instance: s_p_0, and set properties
  set block_name s_p
  set block_cell_name s_p_0
  if { [catch {set s_p_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $s_p_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ad [ create_bd_port -dir I -from 7 -to 0 -type data ad ]
  set ad_iq [ create_bd_port -dir I -from 7 -to 0 -type data ad_iq ]
  set da [ create_bd_port -dir O -from 7 -to 0 -type data da ]
  set da_iq [ create_bd_port -dir O -from 7 -to 0 -type data da_iq ]
...
1#unassigned#unassigned#unassigned#unassigned}\
  ...
  create_hier_cell_reciever [current_bd_instance .] reciever

  # Create instance: sender
  create_hier_cell_sender [current_bd_instance .] sender

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins sender/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP1 [get_bd_intf_pins processing_system7_0/M_AXI_GP1] [get_bd_intf_pins reciever/S00_AXI]
  connect_bd_intf_net -intf_net reciever_M00_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP1] [get_bd_intf_pins reciever/M00_AXI]
  connect_bd_intf_net -intf_net sender_M00_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP0] [get_bd_intf_pins sender/M00_AXI]

  # Create port connections
  connect_bd_net -net ad_1 [get_bd_ports ad] [get_bd_pins sender/ad]
  connect_bd_net -net ad_iq_1 [get_bd_ports ad_iq] [get_bd_pins reciever/ad_iq]
  connect_bd_net -net clk_120M_1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins sender/clk_120M]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins reciever/clk_4M] [get_bd_pins sender/clk_4M]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins reciever/clk_200M]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK3]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins reciever/ext_reset_in] [get_bd_pins sender/ext_reset_in]
  connect_bd_net -net reciever_da [get_bd_ports da] [get_bd_pins reciever/da]
  connect_bd_net -net reciever_data_check [get_bd_pins ila_0/probe2] [get_bd_pins reciever/data_check]
  connect_bd_net -net sender_da_iq [get_bd_ports da_iq] [get_bd_pins sender/da_iq]
  connect_bd_net -net sender_data_out [get_bd_pins ila_0/probe0] [get_bd_pins reciever/data_in] [get_bd_pins sender/data_out]
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces reciever/axi_dma_1/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces sender/axi_dma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces sender/axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
