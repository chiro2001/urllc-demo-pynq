...
# module references:
# ad_buf, mux, div_n, mux, DDCWrapper, ad2dma_rtl, mux, mux, mux, DUCWrapper, ad2dma_rtl
...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource G:/Chiro/Programs/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.srcs/sources_1/bd/urllc_core/urllc_core.bd $design_name
...
proc create_hier_cell_sender { parentCell nameHier } {
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins DUCWrapper_0/io_in_sync] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins data_serial_out] [get_bd_pins DUCWrapper_0/io_in_data] [get_bd_pins xlslice_0/Dout]
...
proc create_hier_cell_reciever { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins resetn_200M] [get_bd_pins DDCWrapper_0/io_resetN] [get_bd_pins rst_ps7_0_200M/peripheral_aresetn]
  ...
  connect_bd_net -net data_in_serial_1 [get_bd_pins data_in_serial] [get_bd_pins mux_1/sel2]
  ...
  connect_bd_net -net mux_0_data_out [get_bd_pins DDCWrapper_0/io_in_data] [get_bd_pins mux_0/data_out]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mux_3/sel1] [get_bd_pins mux_3/sel2] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_debug_ports { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 6 -to 0 debug_pins
...
proc create_hier_cell_data_area { parentCell nameHier } {
  ...
  connect_bd_net -net ad_sel1_1 [get_bd_pins ad_sel1] [get_bd_pins ad_buf_0/ad_sel1] [get_bd_pins sender/ad]
  ...
  connect_bd_net -net mux_mux_data_out [get_bd_pins mux/mux_data_out] [get_bd_pins reciever/ad_iq]
...
1#unassigned#unassigned#unassigned#unassigned}\
  ...
  connect_bd_net -net data_area_data_serial_out [get_bd_pins data_area/data_serial_out] [get_bd_pins ila_0/probe1]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins data_area/irq] [get_bd_pins ila_0/probe3] [get_bd_pins processing_system7_0/IRQ_F2P]

  # Create address segments
  assign_bd_address -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs data_area/sender/axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs data_area/reciever/axi_dma_1/S_AXI_LITE/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces data_area/reciever/axi_dma_1/Data_MM2S] [get_bd_addr_segs data_area/sender/axi_dma_0/S_AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces data_area/reciever/axi_dma_1/Data_MM2S] [get_bd_addr_segs data_area/reciever/axi_dma_1/S_AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces data_area/reciever/axi_dma_1/Data_S2MM] [get_bd_addr_segs data_area/sender/axi_dma_0/S_AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces data_area/reciever/axi_dma_1/Data_S2MM] [get_bd_addr_segs data_area/reciever/axi_dma_1/S_AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces data_area/sender/axi_dma_0/Data_MM2S] [get_bd_addr_segs data_area/sender/axi_dma_0/S_AXI_LITE/Reg]
