...
################################################################
# This is a generated script based on design: urllc_core_inst_2
#
...
# source urllc_core_inst_2_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ad_buf, mux, mux, div_n, mux, DDCWrapper, FrameTrigger, ad2dma_rtl, mux, mux, mux, mux, DUCWrapper, ad2dma_rtl
...
set design_name urllc_core_inst_2
...
proc create_hier_cell_reciever { parentCell nameHier } {
  ...
  # Create instance: FrameTrigger_0, and set properties
  set block_name FrameTrigger
  set block_cell_name FrameTrigger_0
  if { [catch {set FrameTrigger_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $FrameTrigger_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net FrameTriggerWrapper_0_io_out_trigger [get_bd_pins io_out_trigger] [get_bd_pins FrameTrigger_0/io_out_trigger] [get_bd_pins mux_3/sel1] [get_bd_pins xlconcat_irq/In2]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins axi_resetn] [get_bd_pins ad2dma_rtl_0/resetn] [get_bd_pins axi_dma_1/axi_resetn]
  connect_bd_net -net Net [get_bd_pins resetn_200M] [get_bd_pins DDCWrapper_0/io_resetN] [get_bd_pins FrameTrigger_0/reset] [get_bd_pins rst_ps7_0_200M/peripheral_aresetn]
  ...
  connect_bd_net -net clk_200M_1 [get_bd_pins clk_200M] [get_bd_pins DDCWrapper_0/io_clock] [get_bd_pins FrameTrigger_0/clock] [get_bd_pins rst_ps7_0_200M/slowest_sync_clk]
  ...
  connect_bd_net -net frame_trigger_io_in_clear_1 [get_bd_pins frame_trigger_io_in_clear] [get_bd_pins FrameTrigger_0/io_in_clear]
  connect_bd_net -net mux_0_data_out [get_bd_pins DDCWrapper_0/io_in_data] [get_bd_pins FrameTrigger_0/io_in_data] [get_bd_pins mux_0/data_out]
