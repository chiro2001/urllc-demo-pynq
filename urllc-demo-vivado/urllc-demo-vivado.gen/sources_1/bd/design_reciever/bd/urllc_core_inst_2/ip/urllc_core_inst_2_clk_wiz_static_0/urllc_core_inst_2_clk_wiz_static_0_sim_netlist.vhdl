...
-- Command     : write_vhdl -force -mode funcsim -rename_top urllc_core_inst_2_clk_wiz_static_0 -prefix
--               urllc_core_inst_2_clk_wiz_static_0_ urllc_core_inst_2_clk_wiz_static_0_sim_netlist.vhdl
-- Design      : urllc_core_inst_2_clk_wiz_static_0
...
entity urllc_core_inst_2_clk_wiz_static_0_urllc_core_inst_2_clk_wiz_static_0_clk_wiz is
  port (
...
end urllc_core_inst_2_clk_wiz_static_0_urllc_core_inst_2_clk_wiz_static_0_clk_wiz;

architecture STRUCTURE of urllc_core_inst_2_clk_wiz_static_0_urllc_core_inst_2_clk_wiz_static_0_clk_wiz is
  signal clk_in1_urllc_core_inst_2_clk_wiz_static_0 : STD_LOGIC;
  signal clk_out_120M_urllc_core_inst_2_clk_wiz_static_0 : STD_LOGIC;
  signal clk_out_120M_urllc_core_inst_2_clk_wiz_static_0_en_clk : STD_LOGIC;
  signal clk_out_40M_urllc_core_inst_2_clk_wiz_static_0 : STD_LOGIC;
  signal clk_out_40M_urllc_core_inst_2_clk_wiz_static_0_en_clk : STD_LOGIC;
  signal clk_out_8M_urllc_core_inst_2_clk_wiz_static_0 : STD_LOGIC;
  signal clk_out_8M_urllc_core_inst_2_clk_wiz_static_0_en_clk : STD_LOGIC;
  signal clkfbout_buf_urllc_core_inst_2_clk_wiz_static_0 : STD_LOGIC;
  signal clkfbout_urllc_core_inst_2_clk_wiz_static_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_urllc_core_inst_2_clk_wiz_static_0,
      O => clkfbout_buf_urllc_core_inst_2_clk_wiz_static_0
    );
clkin1_bufg: unisim.vcomponents.BUFG
     port map (
      I => clk_in1,
      O => clk_in1_urllc_core_inst_2_clk_wiz_static_0
    );
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out_8M_urllc_core_inst_2_clk_wiz_static_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out_8M,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out_8M_urllc_core_inst_2_clk_wiz_static_0,
      O => clk_out_8M_urllc_core_inst_2_clk_wiz_static_0_en_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_out_40M_urllc_core_inst_2_clk_wiz_static_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out_40M,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out_40M_urllc_core_inst_2_clk_wiz_static_0,
      O => clk_out_40M_urllc_core_inst_2_clk_wiz_static_0_en_clk
    );
clkout3_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg3(7),
      CE1 => '0',
      I0 => clk_out_120M_urllc_core_inst_2_clk_wiz_static_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out_120M,
...
clkout3_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out_120M_urllc_core_inst_2_clk_wiz_static_0,
      O => clk_out_120M_urllc_core_inst_2_clk_wiz_static_0_en_clk
    );
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      STARTUP_WAIT => "FALSE"
        ...
        port map (
      CLKFBIN => clkfbout_buf_urllc_core_inst_2_clk_wiz_static_0,
      CLKFBOUT => clkfbout_urllc_core_inst_2_clk_wiz_static_0,
      CLKIN1 => clk_in1_urllc_core_inst_2_clk_wiz_static_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKOUT0 => clk_out_8M_urllc_core_inst_2_clk_wiz_static_0,
      CLKOUT1 => clk_out_40M_urllc_core_inst_2_clk_wiz_static_0,
      CLKOUT2 => clk_out_120M_urllc_core_inst_2_clk_wiz_static_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_8M_urllc_core_inst_2_clk_wiz_static_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_40M_urllc_core_inst_2_clk_wiz_static_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg2(0)
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_120M_urllc_core_inst_2_clk_wiz_static_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg3(0)
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity urllc_core_inst_2_clk_wiz_static_0 is
  port (
    clk_out_8M : out STD_LOGIC;
    clk_out_40M : out STD_LOGIC;
    clk_out_120M : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of urllc_core_inst_2_clk_wiz_static_0 : entity is true;
end urllc_core_inst_2_clk_wiz_static_0;

architecture STRUCTURE of urllc_core_inst_2_clk_wiz_static_0 is
begin
inst: entity work.urllc_core_inst_2_clk_wiz_static_0_urllc_core_inst_2_clk_wiz_static_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
