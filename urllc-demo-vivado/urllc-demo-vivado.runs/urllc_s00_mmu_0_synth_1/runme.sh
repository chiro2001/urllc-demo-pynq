...
HD_PWD='H:/Chiro/gits/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.runs/urllc_s00_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_s00_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_s00_mmu_0.tcl
