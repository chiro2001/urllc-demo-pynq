...
HD_PWD='H:/Chiro/gits/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.runs/urllc_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_axi_dma_0_0.tcl
