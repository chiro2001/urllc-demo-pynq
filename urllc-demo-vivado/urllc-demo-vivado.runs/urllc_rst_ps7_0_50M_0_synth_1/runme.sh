...
HD_PWD='H:/Chiro/gits/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.runs/urllc_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_rst_ps7_0_50M_0.tcl
