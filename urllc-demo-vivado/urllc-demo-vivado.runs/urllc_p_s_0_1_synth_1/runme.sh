...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.runs/urllc_p_s_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_p_s_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_p_s_0_1.tcl
