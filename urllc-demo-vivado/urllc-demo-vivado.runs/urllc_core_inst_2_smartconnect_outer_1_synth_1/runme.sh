...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-demo-vivado/urllc-demo-vivado.runs/urllc_core_inst_2_smartconnect_outer_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_core_inst_2_smartconnect_outer_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_core_inst_2_smartconnect_outer_1.tcl
