...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-zynq-vivado/urllc-zynq-vivado.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log design_reciever_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_reciever_wrapper.tcl -notrace
