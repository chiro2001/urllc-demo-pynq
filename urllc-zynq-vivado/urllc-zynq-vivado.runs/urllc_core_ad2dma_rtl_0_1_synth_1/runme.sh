...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-zynq-vivado/urllc-zynq-vivado.runs/urllc_core_ad2dma_rtl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_core_ad2dma_rtl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_core_ad2dma_rtl_0_1.tcl
