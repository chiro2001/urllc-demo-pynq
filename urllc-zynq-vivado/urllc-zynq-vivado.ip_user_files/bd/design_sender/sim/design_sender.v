...
module design_sender
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.SENDER_SERIAL_OUT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.SENDER_SERIAL_OUT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output [0:0]sender_serial_out;
  ...
  wire [0:0]urllc_core_0_sender_frame_avaliable;
  wire [0:0]urllc_core_0_sender_serial_out;
  ...
  assign sender_frame_avaliable[0] = urllc_core_0_sender_frame_avaliable;
  assign sender_serial_out[0] = urllc_core_0_sender_serial_out;
  urllc_core_inst_1 urllc_core_0
       (.DDR_addr(DDR_addr[14:0]),
        ...
        .da(urllc_core_0_da),
        .reciever_serial_in(ad_sel1_ready_1),
        .sender_frame_avaliable(urllc_core_0_sender_frame_avaliable),
        .sender_serial_out(urllc_core_0_sender_serial_out));
