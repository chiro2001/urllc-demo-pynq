...
-- Date        : Sat Jan 22 20:05:30 2022
-- Host        : Chiro running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/Programs/urllc-demo-pynq/urllc-vivado/urllc-fifo.srcs/sources_1/bd/urllc_fifo/ip/urllc_fifo_fifo_read_to_axis_0_0/urllc_fifo_fifo_read_to_axis_0_0_sim_netlist.vhdl
-- Design      : urllc_fifo_fifo_read_to_axis_0_0
...
entity urllc_fifo_fifo_read_to_axis_0_0_fifo_read_to_axis is
  port (
  ...
  attribute ORIG_REF_NAME of urllc_fifo_fifo_read_to_axis_0_0_fifo_read_to_axis : entity is "fifo_read_to_axis";
end urllc_fifo_fifo_read_to_axis_0_0_fifo_read_to_axis;

architecture STRUCTURE of urllc_fifo_fifo_read_to_axis_0_0_fifo_read_to_axis is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity urllc_fifo_fifo_read_to_axis_0_0 is
  port (
    clk : in STD_LOGIC;
    resetn : in STD_LOGIC;
    start : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of urllc_fifo_fifo_read_to_axis_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of urllc_fifo_fifo_read_to_axis_0_0 : entity is "urllc_fifo_fifo_read_to_axis_0_0,fifo_read_to_axis,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of urllc_fifo_fifo_read_to_axis_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of urllc_fifo_fifo_read_to_axis_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of urllc_fifo_fifo_read_to_axis_0_0 : entity is "fifo_read_to_axis,Vivado 2018.3";
end urllc_fifo_fifo_read_to_axis_0_0;

architecture STRUCTURE of urllc_fifo_fifo_read_to_axis_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of axis_tlast : signal is "xilinx.com:interface:axis:1.0 axis TLAST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of axis_tlast : signal is "XIL_INTERFACENAME axis, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF axis, ASSOCIATED_RESET resetn, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
...
begin
inst: entity work.urllc_fifo_fifo_read_to_axis_0_0_fifo_read_to_axis
     port map (
