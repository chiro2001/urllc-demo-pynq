...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-vivado/urllc-fifo.runs/impl_sender2'
cd "$HD_PWD"
...
EAStep vivado -log urllc_fifo_sender_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source urllc_fifo_sender_wrapper.tcl -notrace
