...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-vivado/urllc-fifo.runs/urllc_fifo_core_inst_1_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urllc_fifo_core_inst_1_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urllc_fifo_core_inst_1_axi_smc_0.tcl
