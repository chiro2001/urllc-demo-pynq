...
HD_PWD='G:/Chiro/Programs/urllc-demo-pynq/urllc-vivado/urllc-fifo.runs/impl_receiver2'
cd "$HD_PWD"
...
EAStep vivado -log urllc_fifo_receiver_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source urllc_fifo_receiver_wrapper.tcl -notrace
