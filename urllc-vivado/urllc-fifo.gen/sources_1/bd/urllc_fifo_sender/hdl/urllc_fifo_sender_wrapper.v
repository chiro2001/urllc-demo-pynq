...
module urllc_fifo_sender_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire [7:0]sender_da;
  wire sender_da_clk_60M;

  urllc_fifo_sender urllc_fifo_sender_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
        ...
        .sender_da(sender_da),
        .sender_da_clk_60M(sender_da_clk_60M));
endmodule
