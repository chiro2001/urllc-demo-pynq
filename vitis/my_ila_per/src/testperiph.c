...
int main () 
{
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for reciever_axi_dma_1...\r\n");

      status = AxiDMASelfTestExample(XPAR_RECIEVER_AXI_DMA_1_DEVICE_ID);
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for sender_axi_dma_0...\r\n");

      status = AxiDMASelfTestExample(XPAR_SENDER_AXI_DMA_0_DEVICE_ID);
