...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad2dma
 PARAMETER DRIVER_VER = 0.7
 PARAMETER HW_INSTANCE = reciever_ad2dma_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.13
 PARAMETER HW_INSTANCE = reciever_axi_dma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad2dma
 PARAMETER DRIVER_VER = 0.7
 PARAMETER HW_INSTANCE = sender_ad2dma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.13
 PARAMETER HW_INSTANCE = sender_axi_dma_0
END
