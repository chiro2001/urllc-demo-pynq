...
fpga -file G:/Chiro/Programs/urllc-demo-pynq/vitis/urllc_fifo_sender_ps/_ide/bitstream/urllc_fifo_sender.bit
targets -set -nocase -filter {name =~"APU*"}
loadhw -hw G:/Chiro/Programs/urllc-demo-pynq/vitis/urllc_fifo_sender/export/urllc_fifo_sender/hw/urllc_fifo_sender.xsa -mem-ranges [list {0x40000000 0xbfffffff}] -regs
