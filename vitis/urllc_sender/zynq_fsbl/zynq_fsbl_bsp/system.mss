...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = urllc_core_0_data_area_reciever_axi_dma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.13
 PARAMETER HW_INSTANCE = urllc_core_0_data_area_sender_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.8
 PARAMETER HW_INSTANCE = urllc_core_0_debug_ports_axi_gpio_0
END
