...
architecture behav of ad2dma is 
    ...
    "ad2dma_ad2dma,hls_ip_2021_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=64.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.085000,HLS_SYN_LAT=203,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=61,HLS_SYN_LUT=112,HLS_VERSION=2021_1}";
