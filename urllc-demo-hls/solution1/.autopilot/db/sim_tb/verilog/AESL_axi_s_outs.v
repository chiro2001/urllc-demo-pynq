...
`define TV_OUT_outs_TDATA "./impl_rtl.ad2dma.autotvout_outs_V_data_V.dat"
`define EGRESS_STATUS_outs_TDATA "./stream_egress_status_outs_V_data_V.dat"
`define TV_OUT_outs_TKEEP "./impl_rtl.ad2dma.autotvout_outs_V_keep_V.dat"
`define EGRESS_STATUS_outs_TKEEP "./stream_egress_status_outs_V_keep_V.dat"
`define TV_OUT_outs_TSTRB "./impl_rtl.ad2dma.autotvout_outs_V_strb_V.dat"
`define EGRESS_STATUS_outs_TSTRB "./stream_egress_status_outs_V_strb_V.dat"
`define TV_OUT_outs_TUSER "./impl_rtl.ad2dma.autotvout_outs_V_user_V.dat"
`define EGRESS_STATUS_outs_TUSER "./stream_egress_status_outs_V_user_V.dat"
`define TV_OUT_outs_TLAST "./impl_rtl.ad2dma.autotvout_outs_V_last_V.dat"
`define EGRESS_STATUS_outs_TLAST "./stream_egress_status_outs_V_last_V.dat"
`define TV_OUT_outs_TID "./impl_rtl.ad2dma.autotvout_outs_V_id_V.dat"
`define EGRESS_STATUS_outs_TID "./stream_egress_status_outs_V_id_V.dat"
`define TV_OUT_outs_TDEST "./impl_rtl.ad2dma.autotvout_outs_V_dest_V.dat"
`define EGRESS_STATUS_outs_TDEST "./stream_egress_status_outs_V_dest_V.dat"
