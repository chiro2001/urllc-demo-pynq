...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ad2dma.autotvin.dat"
	set constFileTvOut       "ad2dma.autotvout.dat"
	set constFileHdlTvIn     "ad2dma.autohdltvin.dat"
	set constFileHdlTvOut    "ad2dma.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
