...
"
   ...
   if { $list_mods_missing ne "" } {
      ...
      common::send_msg_id "BD_TCL-006" "INFO" "Please add source files for the missing module(s) above."
      set bCheckIPsPassed 0
   }
}
...
if { $bCheckIPsPassed != 1 } {
  ...
  common::send_msg_id "BD_TCL-006" "WARNING" "Will not continue with creation of design due to the error(s) above."
  return 3
}
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x00000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces core/axi_dma_0/Data_MM2S] [get_bd_addr_segs core/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM]
  assign_bd_address -offset 0x00000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces core/axi_dma_0/Data_S2MM] [get_bd_addr_segs core/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM]
  assign_bd_address -offset 0x10000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces core/axi_dma_0/Data_MM2S] [get_bd_addr_segs core/processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM]
  assign_bd_address -offset 0x10000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces core/axi_dma_0/Data_S2MM] [get_bd_addr_segs core/processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM]
  assign_bd_address -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces core/processing_system7_0/Data] [get_bd_addr_segs core/axi_dma_0/S_AXI_LITE/Reg]
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces core/processing_system7_0/Data] [get_bd_addr_segs debug_ctrl/axi_gpio_0/S_AXI/Reg]
