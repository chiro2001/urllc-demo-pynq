...
--               D:/Programs/urllc-demo-pynq/urllc-vivado-2018/urllc-vivado-2018.srcs/sources_1/bd/test_fifo_axis/ip/test_fifo_axis_dac_axis_0_1/test_fifo_axis_dac_axis_0_1_sim_netlist.vhdl
...
entity test_fifo_axis_dac_axis_0_1_dac_axis is
  port (
  ...
  attribute ORIG_REF_NAME of test_fifo_axis_dac_axis_0_1_dac_axis : entity is "dac_axis";
end test_fifo_axis_dac_axis_0_1_dac_axis;

architecture STRUCTURE of test_fifo_axis_dac_axis_0_1_dac_axis is
  ...
  attribute SOFT_HLUTNM of \da[7]_i_7\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \da[7]_i_8\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \da[7]_i_9\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of vld_i_2 : label is "soft_lutpair2";
begin
...
\da[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\da[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000140000"
    )
        port map (
...
\da[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000140000"
    )
        port map (
...
\da[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000140000"
    )
        port map (
...
\da[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000140000"
    )
        port map (
...
\da[7]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\da[7]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\da[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\da[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\da[7]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\da[7]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\da[7]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5556AAA9"
    )
        port map (
...
vld_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
vld_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"94020294"
    )
        port map (
...
vld_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
entity test_fifo_axis_dac_axis_0_1 is
  ...
  attribute NotValidForBitStream of test_fifo_axis_dac_axis_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of test_fifo_axis_dac_axis_0_1 : entity is "test_fifo_axis_dac_axis_0_1,dac_axis,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of test_fifo_axis_dac_axis_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of test_fifo_axis_dac_axis_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of test_fifo_axis_dac_axis_0_1 : entity is "dac_axis,Vivado 2018.3";
end test_fifo_axis_dac_axis_0_1;

architecture STRUCTURE of test_fifo_axis_dac_axis_0_1 is
  ...
  attribute X_INTERFACE_PARAMETER of axis_tready : signal is "XIL_INTERFACENAME axis, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 60000000, PHASE 0.0, CLK_DOMAIN test_fifo_axis_clk, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of axis_tvalid : signal is "xilinx.com:interface:axis:1.0 axis TVALID";
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF axis, ASSOCIATED_RESET resetn, FREQ_HZ 60000000, PHASE 0.0, CLK_DOMAIN test_fifo_axis_clk, INSERT_VIP 0";
...
inst: entity work.test_fifo_axis_dac_axis_0_1_dac_axis
     port map (
