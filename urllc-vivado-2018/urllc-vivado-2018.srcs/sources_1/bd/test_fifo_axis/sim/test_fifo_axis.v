...
module adc_imp_1P5RL9V
  ...
  assign fifo_almost_full_1 = fifo_almost_full;
  ...
  test_fifo_axis_adc_axis_0_0 adc_axis_0
       (.ad_in(mux_reciever_in_data_out),
        ...
        .fifo_almost_full(fifo_almost_full_1),
        .resetn(Net1));
...
module test_fifo_axis
  ...
  wire axis_data_fifo_inout_prog_empty;
  wire axis_data_fifo_inout_prog_full;
  wire clk_0_1;
  wire [7:0]dac_da;
  wire [7:0]div_0_1;
  wire [7:0]div_1_1;
  ...
  adc_imp_1P5RL9V adc
       (.ad(ad_0_1),
        ...
        .div(div_0_1),
        .fifo_almost_empty(axis_data_fifo_inout_prog_empty),
        .fifo_almost_full(axis_data_fifo_inout_prog_full),
        .io_clock(clk_0_1),
  ...
  test_fifo_axis_axis_data_fifo_dac_0 axis_data_fifo_inout
       (.m_axis_tdata(axis_data_fifo_inout_M_AXIS_TDATA),
        ...
        .prog_empty(axis_data_fifo_inout_prog_empty),
        .prog_full(axis_data_fifo_inout_prog_full),
        .s_axis_aclk(clk_0_1),
