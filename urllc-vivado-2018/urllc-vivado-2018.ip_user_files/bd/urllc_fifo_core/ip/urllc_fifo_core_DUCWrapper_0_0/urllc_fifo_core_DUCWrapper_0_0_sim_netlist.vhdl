...
-- Date        : Fri Feb  4 16:53:15 2022
-- Host        : Chiro running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/Programs/urllc-demo-pynq/urllc-vivado-2018/urllc-vivado-2018.srcs/sources_1/bd/urllc_fifo_core/ip/urllc_fifo_core_DUCWrapper_0_0/urllc_fifo_core_DUCWrapper_0_0_sim_netlist.vhdl
...
entity urllc_fifo_core_DUCWrapper_0_0_DUC is
  port (
  ...
  attribute ORIG_REF_NAME of urllc_fifo_core_DUCWrapper_0_0_DUC : entity is "DUC";
end urllc_fifo_core_DUCWrapper_0_0_DUC;

architecture STRUCTURE of urllc_fifo_core_DUCWrapper_0_0_DUC is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity urllc_fifo_core_DUCWrapper_0_0_DUCWrapper is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of urllc_fifo_core_DUCWrapper_0_0_DUCWrapper : entity is "DUCWrapper";
end urllc_fifo_core_DUCWrapper_0_0_DUCWrapper;

architecture STRUCTURE of urllc_fifo_core_DUCWrapper_0_0_DUCWrapper is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of buffer_16_dac_reg_gate : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \buffer_16_dac_reg_gate__0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \buffer_16_dac_reg_gate__1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \buffer_16_dac_reg_gate__2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \buffer_16_dac_reg_gate__3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \buffer_16_dac_reg_gate__4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \buffer_16_dac_reg_gate__5\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \io_out_dac[1]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \io_out_dac[2]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \io_out_dac[3]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \io_out_dac[4]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \io_out_dac[5]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \io_out_dac[6]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \io_out_dac[7]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of io_out_sync_INST_0 : label is "soft_lutpair7";
...
\module_\: entity work.urllc_fifo_core_DUCWrapper_0_0_DUC
     port map (
      io_clock => io_clock,
...
entity urllc_fifo_core_DUCWrapper_0_0 is
  ...
  attribute NotValidForBitStream of urllc_fifo_core_DUCWrapper_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of urllc_fifo_core_DUCWrapper_0_0 : entity is "urllc_fifo_core_DUCWrapper_0_0,DUCWrapper,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of urllc_fifo_core_DUCWrapper_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of urllc_fifo_core_DUCWrapper_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of urllc_fifo_core_DUCWrapper_0_0 : entity is "DUCWrapper,Vivado 2018.3";
end urllc_fifo_core_DUCWrapper_0_0;

architecture STRUCTURE of urllc_fifo_core_DUCWrapper_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of io_clock : signal is "xilinx.com:signal:clock:1.0 io_clock CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of io_clock : signal is "XIL_INTERFACENAME io_clock, ASSOCIATED_RESET io_resetN, FREQ_HZ 60000000, PHASE 0.0, CLK_DOMAIN /core/clk_static_clk_out1, INSERT_VIP 0";
...
begin
inst: entity work.urllc_fifo_core_DUCWrapper_0_0_DUCWrapper
     port map (
      io_clock => io_clock,
      io_in_data => io_in_data,
      io_in_sync => io_in_sync,
